export default function Home() {
  return (
    <section className="flex flex-col items-center content-center p-5 w-6xl">
      ...
      <div className="w-full max-w-6xl mx-5 mt-3">
        <p className="mb-2 text-2xl transition transition-colors duration-1000 text-slate-800 text-md dark:text-gray-50">
          I&apos;m a software engineer based in San Diego, California. I&apos;m
          currently building software for the FAIR Data Innovations Hub that
          assists Biomedical researchers with uploading datasets that comply
          with the FAIR SPARC data curation and sharing guidelines.
        </p>
      </div>
      <div className="w-full max-w-6xl mx-5 mt-3">
        <p className="mb-2 text-2xl transition transition-colors duration-1000 text-slate-800 text-md dark:text-gray-50">
      ...
      <div className="w-full max-w-6xl mx-5 mt-3">
        <p className="mb-2 text-2xl transition transition-colors duration-1000 text-slate-800 text-md dark:text-gray-50">
          My strongets skillset is frond-end development, however, I am growing
          my back-end skillset and thoroughly enjoy all other aspects of
